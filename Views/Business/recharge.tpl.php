<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 充值统计</a></li>
...
<table class="table table-striped table-bordered table-hover datatable">
    <thead>
    <tr>
        <th>时间</th><th>申请充值次数</th><th>成功充值次数</th><th>申请充值金额</th><th>成功充值金额</th>
    </tr>
    </thead>
    <tbody>
    <?php echo $table_data;?>

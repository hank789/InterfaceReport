...
function logger($module, $interface, $date, $start_time, $offset, $count)
{
	...
	unset($_GET['fn'], $_GET['ip'], $_GET['offset'],$_GET['md']);
	$log_str = '';
	...
	$log_str .= "</br><center><a href='/?md=performance&fn=logger&$next_page_url'>下一页</a></center>";
	
	include ST_ROOT . '/Views/Includes/header.tpl.php';
	include ST_ROOT . '/Views/Performance/log.tpl.php';
